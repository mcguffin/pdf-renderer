...
You can can either go into the Support forum, or in the [PDF Renderer Repository](https://github.com//pdf-renderer).

= I'd like to suggest a feature. Where should I post it? =

I personally prefer GitHub. The plugin code is here: [GitHub](https://github.com//pdf-renderer)
(See above as well.)
...
3. type `git clone git@github.com:/pdf-renderer.git`
...
Either post it on the [GitHub-repo](https://github.com//pdf-renderer) or—if you cloned the repository—send me a pull request.
